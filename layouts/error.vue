<template>
  <div>
    <div v-if="error.statusCode === 404"  class="bg-indigo-900 relative overflow-hidden h-screen">
      <img src="~/static/sprite/8.svg" class="absolute h-full w-full object-cover"/>
