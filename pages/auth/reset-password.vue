    ...
    <div
      ...
      <div class="mt-8">
        <form action="#" v-on:submit.prevent="forgotPassword" autoComplete="off">
          ...
          <Input v-model="form.password" type="password" placeholder="Please enter a new password" iconLeft="/sprite/passwordIcon.svg" width="30" :error="errors.email && errors.email[0] ? errors.email[0] : ''"/>
          <Input v-model="form.password_confirmation" type="password" placeholder="Please confirm the password" iconLeft="/sprite/passwordIcon.svg" width="30" :error="errors.email && errors.email[0] ? errors.email[0] : ''"/>
